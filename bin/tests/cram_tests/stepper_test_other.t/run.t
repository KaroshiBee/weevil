testing with no filename and not headless
  $ for n in 016 015 014 013 012 011; do weevil_mdb_$n stepper; done
  weevil_mdb_016: Stepper error - Error:
                                    Invalid_argument("required argument FILE is missing")
                  
                  
  Usage: weevil_mdb_016 stepper [OPTION]… [FILE]
  Try 'weevil_mdb_016 stepper --help' or 'weevil_mdb_016 --help' for more information.
...
testing with no filename in headless mode
  $ for n in 016 015 014 013 012 011; do weevil_mdb_$n stepper --headless; done
  Content-Length: 133
...
testing with bad filename in headless mode
  $ for n in 016 015 014 013 012 011; do weevil_mdb_$n stepper -h notthere.tz; done
  Content-Length: 161
