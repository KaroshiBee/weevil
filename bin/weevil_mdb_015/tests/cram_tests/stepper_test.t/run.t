...
testing a contract that has a failwith, it should incrementally step up to it and then fail
  ...
  { "location":    { "start": { "line": 9, "column": 7, "point": 143, "byte": 143 },      "stop": { "line": 9, "column": 24, "point": 160, "byte": 160 } },  "gas": "91.719 units remaining", "stack": [ "\"BOO\"", "True", "7", "5" ] }weevil_mdb_015:
  Content-Length: 368
  
  { "error":    [ { "kind": "temporary",        "id": "proto.015-PtKathma.michelson_v1.runtime_error",        "contract_handle": "KT1BEqzn5Wx8uJrZNvuS9DVHmLvG9td3fDLi",        "contract_code": "Deprecated" },      { "kind": "temporary",        "id": "proto.015-PtKathma.michelson_v1.script_rejected",        "location": 20, "with": { "string": "BOO" }, "trace": [] } ] }
  [124]
