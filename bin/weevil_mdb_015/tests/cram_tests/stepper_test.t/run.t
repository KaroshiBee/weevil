...
I send in 10 newlines to check that its ok to send them when it is finished
  ...
  $ echo "\n \n \n \n \n \n \n \n \n \n" | weevil_mdb_015 stepper --headless multiply_2_x_250_equals_500.tz | sed 's/^[ \n]*//' | sed 's/[ \n]*$//'
  Content-Length: 217
...
testing a contract that has a failwith, it should incrementally step up to it and then fail
  $ echo "\n \n \n \n \n \n \n \n \n \n" | weevil_mdb_015 stepper --headless --storage '0' --parameter '(Pair 7 5)' failwith.tz 2>&1 | sed 's/weevil_mdb_015\://' | sed 's/^[ \n]*//' | sed 's/[ \n]*$//'
  Content-Length: 220
...
testing with no filename and not headless
  $ weevil_mdb_015 stepper 2>&1 | sed 's/weevil_mdb_015\://' | sed 's/^[ \n]*//' | sed 's/[ \n]*$//'
  Stepper error - Error:
...
testing with bad michelson in headless mode
  $ weevil_mdb_015 stepper -h bad_michelson.tz 2>&1 | sed 's/weevil_mdb_015\://' | sed 's/^[ \n]*//' | sed 's/[ \n]*$//'
