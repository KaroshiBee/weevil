  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "external" -> External
        | _ -> failwith "Unknown RunInTerminalRequestArguments_kind")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "end" -> End
        | _ -> failwith "Unknown OutputEvent_body_group")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        | "indexed" -> Indexed
        | "named" -> Named
        | _ -> failwith "Unknown VariablesArguments_filter")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "boolean" -> Boolean
        | "unixTimestampUTC" -> UnixTimestampUTC
        | _ -> failwith "Unknown ColumnDescriptor_type")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "changed" -> Changed
        | "removed" -> Removed
        | _ -> failwith "Unknown LoadedSourceEvent_body_reason")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "changed" -> Changed
        | "removed" -> Removed
        | _ -> failwith "Unknown ModuleEvent_body_reason")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "write" -> Write
        | "readWrite" -> ReadWrite
        | _ -> failwith "Unknown DataBreakpointAccessType")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "SHA256" -> SHA256
        | "timestamp" -> Timestamp
        | _ -> failwith "Unknown ChecksumAlgorithm")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "attach" -> Attach
        | "attachForSuspendedLaunch" -> AttachForSuspendedLaunch
        | _ -> failwith "Unknown ProcessEvent_body_startMethod")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "unhandled" -> Unhandled
        | "userUnhandled" -> UserUnhandled
        | _ -> failwith "Unknown ExceptionBreakMode")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "line" -> Line
        | "instruction" -> Instruction
        | _ -> failwith "Unknown SteppingGranularity")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "emphasize" -> Emphasize
        | "deemphasize" -> Deemphasize
        | _ -> failwith "Unknown Source_presentationHint")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "label" -> Label
        | "subtle" -> Subtle
        | _ -> failwith "Unknown StackFrame_presentationHint")
      string
end
  ...
  let enc =
    ...
    conv
      ...
      (function
        ...
        | "reference" -> Reference
        | "customcolor" -> Customcolor
        | _ -> failwith "Unknown CompletionItemType")
      string
end
