...
type (_, _, _) request =
  ...
  | ContinueRequest :
      ( Dap_command.continue,
        ...
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.continue, ContinueArguments.t, RequestMessage.req) request
  | NextRequest :
      (Dap_command.next, NextArguments.t, RequestMessage.req) RequestMessage.t
      -> (Dap_command.next, NextArguments.t, RequestMessage.req) request
  | StepInRequest :
      ( Dap_command.stepIn,
        StepInArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.stepIn, StepInArguments.t, RequestMessage.req) request
  | StepOutRequest :
      ( Dap_command.stepOut,
        StepOutArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.stepOut, StepOutArguments.t, RequestMessage.req) request
  | StepBackRequest :
      ( Dap_command.stepBack,
        StepBackArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.stepBack, StepBackArguments.t, RequestMessage.req) request
  | ReverseContinueRequest :
      ( Dap_command.reverseContinue,
        ReverseContinueArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> ( Dap_command.reverseContinue,
  ...
  | RestartFrameRequest :
      ...
      -> ( Dap_command.restartFrame,
         ...
         request
  | GotoRequest :
      (Dap_command.goto, GotoArguments.t, RequestMessage.req) RequestMessage.t
      -> (Dap_command.goto, GotoArguments.t, RequestMessage.req) request
  | PauseRequest :
      (Dap_command.pause, PauseArguments.t, RequestMessage.req) RequestMessage.t
      -> (Dap_command.pause, PauseArguments.t, RequestMessage.req) request
  | StackTraceRequest :
      ( Dap_command.stackTrace,
        StackTraceArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> ( Dap_command.stackTrace,
  ...
  | ScopesRequest :
      ( Dap_command.scopes,
        ...
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.scopes, ScopesArguments.t, RequestMessage.req) request
  | VariablesRequest :
      ( Dap_command.variables,
        VariablesArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> ( Dap_command.variables,
  ...
  | SourceRequest :
      ( Dap_command.source,
        ...
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.source, SourceArguments.t, RequestMessage.req) request
  | ThreadsRequest :
      ( Dap_command.threads,
        EmptyObject.t option,
        RequestMessage.opt )
      RequestMessage.t
      -> (Dap_command.threads, EmptyObject.t option, RequestMessage.opt) request
  ...
  | ModulesRequest :
      ( Dap_command.modules,
        ...
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.modules, ModulesArguments.t, RequestMessage.req) request
  | LoadedSourcesRequest :
      ...
      -> ( Dap_command.loadedSources,
         ...
         request
  | EvaluateRequest :
      ( Dap_command.evaluate,
        EvaluateArguments.t,
        RequestMessage.req )
      RequestMessage.t
      -> (Dap_command.evaluate, EvaluateArguments.t, RequestMessage.req) request
...
type (_, _, _) response =
  | ErrorResponse :
      ( Dap_command.error,
        ...
        ResponseMessage.req )
      ResponseMessage.t
      -> (Dap_command.error, ErrorResponse_body.t, ResponseMessage.req) response
  | CancelResponse :
      ( Dap_command.cancel,
        EmptyObject.t option,
        ResponseMessage.opt )
  ...
  | NextResponse :
      ( Dap_command.next,
        ...
        ResponseMessage.opt )
      ResponseMessage.t
      -> (Dap_command.next, EmptyObject.t option, ResponseMessage.opt) response
  | StepInResponse :
      ( Dap_command.stepIn,
        EmptyObject.t option,
        ResponseMessage.opt )
  ...
  | GotoResponse :
      ( Dap_command.goto,
        ...
        ResponseMessage.opt )
      ResponseMessage.t
      -> (Dap_command.goto, EmptyObject.t option, ResponseMessage.opt) response
  | PauseResponse :
      ( Dap_command.pause,
        EmptyObject.t option,
        ResponseMessage.opt )
      ResponseMessage.t
      -> (Dap_command.pause, EmptyObject.t option, ResponseMessage.opt) response
  | StackTraceResponse :
      ( Dap_command.stackTrace,
        StackTraceResponse_body.t,
        ResponseMessage.req )
...
type (_, _, _) event =
  | InitializedEvent :
      ( Dap_event.initialized,
        ...
        EventMessage.opt )
      EventMessage.t
      -> (Dap_event.initialized, EmptyObject.t option, EventMessage.opt) event
  | StoppedEvent :
      (Dap_event.stopped, StoppedEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.stopped, StoppedEvent_body.t, EventMessage.req) event
  | ContinuedEvent :
      ( Dap_event.continued,
        ContinuedEvent_body.t,
        EventMessage.req )
      EventMessage.t
      -> (Dap_event.continued, ContinuedEvent_body.t, EventMessage.req) event
  | ExitedEvent :
      (Dap_event.exited, ExitedEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.exited, ExitedEvent_body.t, EventMessage.req) event
  | TerminatedEvent :
      ...
      -> ( Dap_event.terminated,
         ...
         event
  | ThreadEvent :
      (Dap_event.thread, ThreadEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.thread, ThreadEvent_body.t, EventMessage.req) event
  | OutputEvent :
      (Dap_event.output, OutputEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.output, OutputEvent_body.t, EventMessage.req) event
  | BreakpointEvent :
      ( Dap_event.breakpoint,
        BreakpointEvent_body.t,
        EventMessage.req )
      EventMessage.t
      -> (Dap_event.breakpoint, BreakpointEvent_body.t, EventMessage.req) event
  | ModuleEvent :
      (Dap_event.module_, ModuleEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.module_, ModuleEvent_body.t, EventMessage.req) event
  | LoadedSourceEvent :
      ( Dap_event.loadedSource,
        LoadedSourceEvent_body.t,
        EventMessage.req )
      EventMessage.t
      -> ( Dap_event.loadedSource,
         ...
         event
  | ProcessEvent :
      (Dap_event.process, ProcessEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.process, ProcessEvent_body.t, EventMessage.req) event
  | CapabilitiesEvent :
      ( Dap_event.capabilities,
        CapabilitiesEvent_body.t,
        EventMessage.req )
      EventMessage.t
      -> ( Dap_event.capabilities,
  ...
  | InvalidatedEvent :
      ...
      -> ( Dap_event.invalidated,
         ...
         event
  | MemoryEvent :
      (Dap_event.memory, MemoryEvent_body.t, EventMessage.req) EventMessage.t
      -> (Dap_event.memory, MemoryEvent_body.t, EventMessage.req) event
