...
(option @@ list Checksum.gen)
          ...
          | n ->
            frequency
              [
                (1, _gen_t basecase);
                (1, let t = map (fun {sources; _} -> sources) @@ self (n - 1) in _gen_t t);
              ]
        )) 
...
let gen_cancelResponse = (cancelResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.cancel ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.cancel EmptyObject.enc)
let gen_runInTerminalResponse = (runInTerminalResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.runInTerminal ~body ()) @@ tup2 Gen.gen_int31 RunInTerminalResponse_body.gen ), ResponseMessage.enc Dap_commands.runInTerminal RunInTerminalResponse_body.enc)
let gen_initializeResponse = (initializeResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.initialize ~body ()) @@ tup2 Gen.gen_int31 Capabilities.gen ), ResponseMessage.enc_opt Dap_commands.initialize Capabilities.enc)
let gen_configurationDoneResponse = (configurationDoneResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.configurationDone ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.configurationDone EmptyObject.enc)
let gen_launchResponse = (launchResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.launch ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.launch EmptyObject.enc)
let gen_attachResponse = (attachResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.attach ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.attach EmptyObject.enc)
let gen_restartResponse = (restartResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.restart ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.restart EmptyObject.enc)
let gen_disconnectResponse = (disconnectResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.disconnect ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.disconnect EmptyObject.enc)
let gen_terminateResponse = (terminateResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.terminate ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.terminate EmptyObject.enc)
let gen_breakpointLocationsResponse = (breakpointLocationsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.breakpointLocations ~body ()) @@ tup2 Gen.gen_int31 BreakpointLocationsResponse_body.gen ), ResponseMessage.enc Dap_commands.breakpointLocations BreakpointLocationsResponse_body.enc)
let gen_setBreakpointsResponse = (setBreakpointsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.setBreakpoints ~body ()) @@ tup2 Gen.gen_int31 SetBreakpointsResponse_body.gen ), ResponseMessage.enc Dap_commands.setBreakpoints SetBreakpointsResponse_body.enc)
let gen_setFunctionBreakpointsResponse = (setFunctionBreakpointsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.setFunctionBreakpoints ~body ()) @@ tup2 Gen.gen_int31 SetFunctionBreakpointsResponse_body.gen ), ResponseMessage.enc Dap_commands.setFunctionBreakpoints SetFunctionBreakpointsResponse_body.enc)
let gen_setExceptionBreakpointsResponse = (setExceptionBreakpointsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.setExceptionBreakpoints ~body ()) @@ tup2 Gen.gen_int31 SetExceptionBreakpointsResponse_body.gen ), ResponseMessage.enc_opt Dap_commands.setExceptionBreakpoints SetExceptionBreakpointsResponse_body.enc)
let gen_dataBreakpointInfoResponse = (dataBreakpointInfoResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.dataBreakpointInfo ~body ()) @@ tup2 Gen.gen_int31 DataBreakpointInfoResponse_body.gen ), ResponseMessage.enc Dap_commands.dataBreakpointInfo DataBreakpointInfoResponse_body.enc)
let gen_setDataBreakpointsResponse = (setDataBreakpointsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.setDataBreakpoints ~body ()) @@ tup2 Gen.gen_int31 SetDataBreakpointsResponse_body.gen ), ResponseMessage.enc Dap_commands.setDataBreakpoints SetDataBreakpointsResponse_body.enc)
let gen_setInstructionBreakpointsResponse = (setInstructionBreakpointsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.setInstructionBreakpoints ~body ()) @@ tup2 Gen.gen_int31 SetInstructionBreakpointsResponse_body.gen ), ResponseMessage.enc Dap_commands.setInstructionBreakpoints SetInstructionBreakpointsResponse_body.enc)
let gen_continueResponse = (continueResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.continue ~body ()) @@ tup2 Gen.gen_int31 ContinueResponse_body.gen ), ResponseMessage.enc Dap_commands.continue ContinueResponse_body.enc)
let gen_nextResponse = (nextResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.next ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.next EmptyObject.enc)
let gen_stepInResponse = (stepInResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.stepIn ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.stepIn EmptyObject.enc)
let gen_stepOutResponse = (stepOutResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.stepOut ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.stepOut EmptyObject.enc)
let gen_stepBackResponse = (stepBackResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.stepBack ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.stepBack EmptyObject.enc)
let gen_reverseContinueResponse = (reverseContinueResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.reverseContinue ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.reverseContinue EmptyObject.enc)
let gen_restartFrameResponse = (restartFrameResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.restartFrame ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.restartFrame EmptyObject.enc)
let gen_gotoResponse = (gotoResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.goto ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.goto EmptyObject.enc)
let gen_pauseResponse = (pauseResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.pause ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.pause EmptyObject.enc)
let gen_stackTraceResponse = (stackTraceResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.stackTrace ~body ()) @@ tup2 Gen.gen_int31 StackTraceResponse_body.gen ), ResponseMessage.enc Dap_commands.stackTrace StackTraceResponse_body.enc)
let gen_scopesResponse = (scopesResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.scopes ~body ()) @@ tup2 Gen.gen_int31 ScopesResponse_body.gen ), ResponseMessage.enc Dap_commands.scopes ScopesResponse_body.enc)
let gen_variablesResponse = (variablesResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.variables ~body ()) @@ tup2 Gen.gen_int31 VariablesResponse_body.gen ), ResponseMessage.enc Dap_commands.variables VariablesResponse_body.enc)
let gen_setVariableResponse = (setVariableResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.setVariable ~body ()) @@ tup2 Gen.gen_int31 SetVariableResponse_body.gen ), ResponseMessage.enc Dap_commands.setVariable SetVariableResponse_body.enc)
let gen_sourceResponse = (sourceResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.source ~body ()) @@ tup2 Gen.gen_int31 SourceResponse_body.gen ), ResponseMessage.enc Dap_commands.source SourceResponse_body.enc)
let gen_threadsResponse = (threadsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.threads ~body ()) @@ tup2 Gen.gen_int31 ThreadsResponse_body.gen ), ResponseMessage.enc Dap_commands.threads ThreadsResponse_body.enc)
let gen_terminateThreadsResponse = (terminateThreadsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.terminateThreads ~body ()) @@ tup2 Gen.gen_int31 EmptyObject.gen ), ResponseMessage.enc_opt Dap_commands.terminateThreads EmptyObject.enc)
let gen_modulesResponse = (modulesResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.modules ~body ()) @@ tup2 Gen.gen_int31 ModulesResponse_body.gen ), ResponseMessage.enc Dap_commands.modules ModulesResponse_body.enc)
let gen_loadedSourcesResponse = (loadedSourcesResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.loadedSources ~body ()) @@ tup2 Gen.gen_int31 LoadedSourcesResponse_body.gen ), ResponseMessage.enc Dap_commands.loadedSources LoadedSourcesResponse_body.enc)
let gen_evaluateResponse = (evaluateResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.evaluate ~body ()) @@ tup2 Gen.gen_int31 EvaluateResponse_body.gen ), ResponseMessage.enc Dap_commands.evaluate EvaluateResponse_body.enc)
let gen_setExpressionResponse = (setExpressionResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.setExpression ~body ()) @@ tup2 Gen.gen_int31 SetExpressionResponse_body.gen ), ResponseMessage.enc Dap_commands.setExpression SetExpressionResponse_body.enc)
let gen_stepInTargetsResponse = (stepInTargetsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.stepInTargets ~body ()) @@ tup2 Gen.gen_int31 StepInTargetsResponse_body.gen ), ResponseMessage.enc Dap_commands.stepInTargets StepInTargetsResponse_body.enc)
let gen_gotoTargetsResponse = (gotoTargetsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.gotoTargets ~body ()) @@ tup2 Gen.gen_int31 GotoTargetsResponse_body.gen ), ResponseMessage.enc Dap_commands.gotoTargets GotoTargetsResponse_body.enc)
let gen_completionsResponse = (completionsResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.completions ~body ()) @@ tup2 Gen.gen_int31 CompletionsResponse_body.gen ), ResponseMessage.enc Dap_commands.completions CompletionsResponse_body.enc)
let gen_exceptionInfoResponse = (exceptionInfoResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make ~seq ~command:Dap_commands.exceptionInfo ~body ()) @@ tup2 Gen.gen_int31 ExceptionInfoResponse_body.gen ), ResponseMessage.enc Dap_commands.exceptionInfo ExceptionInfoResponse_body.enc)
let gen_readMemoryResponse = (readMemoryResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.readMemory ~body ()) @@ tup2 Gen.gen_int31 ReadMemoryResponse_body.gen ), ResponseMessage.enc_opt Dap_commands.readMemory ReadMemoryResponse_body.enc)
let gen_writeMemoryResponse = (writeMemoryResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.writeMemory ~body ()) @@ tup2 Gen.gen_int31 WriteMemoryResponse_body.gen ), ResponseMessage.enc_opt Dap_commands.writeMemory WriteMemoryResponse_body.enc)
let gen_disassembleResponse = (disassembleResponse, QCheck.Gen.( map (fun (seq, body) -> ResponseMessage.make_opt ~seq ~command:Dap_commands.disassemble ~body ()) @@ tup2 Gen.gen_int31 DisassembleResponse_body.gen ), ResponseMessage.enc_opt Dap_commands.disassemble DisassembleResponse_body.enc)
