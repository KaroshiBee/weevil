...
module Data = struct
  ...
  module Message : sig
    ...
    type t = {
      ...
      variables :
        ...
        [@gen Gen.gen_json_opt] [@equal Eq.equal_json_opt]);
               ...
               | n ->
                   frequency
                     [
                       ...
                       ( 1,
                         let t =
                           map (fun {sources; _} -> sources) @@ self (n / 2)
                         in
                         _gen_t t );
                     ]))
  ...
  module Capabilities : sig
    ...
    module Capabilities_0 = struct
      ...
      let supportsConfigurationDoneRequest t =
        t.supportsConfigurationDoneRequest
    ...
    module Capabilities_20 = struct
      ...
      let supportsDelayedStackTraceLoading t =
    ...
    let make ?supportsConfigurationDoneRequest ?supportsFunctionBreakpoints
        ...
        ?supportsSetExpression ?supportsTerminateRequest
        ?supportsDataBreakpoints ?supportsReadMemoryRequest
        ?supportsWriteMemoryRequest ?supportsDisassembleRequest
        ?supportsCancelRequest ?supportsBreakpointLocationsRequest
        ?supportsClipboardContext ?supportsSteppingGranularity
        ?supportsInstructionBreakpoints ?supportsExceptionFilterOptions
        ?supportsSingleThreadExecutionRequests () =
  ...
  module MemoryEvent_body : sig
    ...
    let enc =
      ...
      (* MemoryEvent_body.t *)
      conv
        (fun {memoryReference; offset; count} ->
  ...
  module InitializeRequestArguments_pathFormat = struct
    ...
    let enc =
      ...
      conv_with_guard
        ...
        (function
          | "path" -> Ok Path | "uri" -> Ok Uri | _ as s -> Ok (Other s))
        string
  end
  ...
  module InitializeRequestArguments : sig
    ...
    let linesStartAt1 (_t0, _t1) =
      InitializeRequestArguments_0.linesStartAt1 _t0
  ...
  module VariablePresentationHint : sig
    ...
    val attributes :
      t -> VariablePresentationHint_attributes_items.t list option
    ...
    let enc =
      ...
      conv
        ...
        (obj4
           ...
           (opt
              "attributes"
              (list VariablePresentationHint_attributes_items.enc))
  ...
  module EvaluateResponse_body : sig
    ...
    let make ~result ?type_ ?presentationHint ~variablesReference
  ...
  module CompletionItem : sig
    ...
    let make ~label ?text ?sortText ?detail ?type_ ?start ?length
               ...
               | n ->
                   frequency
                     [
                       ...
                       ( 1,
                         let t =
                           map (fun {innerException; _} -> innerException)
                           @@ self (n / 2)
                         in
                         _gen_t t );
                     ]))
  ...
  module ReadMemoryResponse_body : sig
    ...
    let enc =
      ...
      conv
        (fun {address; unreadableBytes; data} ->
...
module Request = struct
  ...
  type _ t =
    ...
    | NextRequest :
        ...
        -> (Dap_commands.next, NextArguments.t, Presence.req) RequestMessage.t t
    | StepInRequest :
    ...
    | GotoRequest :
        ...
        -> (Dap_commands.goto, GotoArguments.t, Presence.req) RequestMessage.t t
    | PauseRequest :
  ...
  let setInstructionBreakpointsRequest req =
    SetInstructionBreakpointsRequest req
  ...
  (* request qcheck *)
  let gen_cancelRequest =
    ( cancelRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.cancel
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 CancelArguments.gen),
      RequestMessage.enc_opt Dap_commands.cancel CancelArguments.enc )

  let gen_runInTerminalRequest =
    ( runInTerminalRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.runInTerminal
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 RunInTerminalRequestArguments.gen),
      RequestMessage.enc
        Dap_commands.runInTerminal
        RunInTerminalRequestArguments.enc )

  let gen_initializeRequest =
    ( initializeRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.initialize
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 InitializeRequestArguments.gen),
      RequestMessage.enc Dap_commands.initialize InitializeRequestArguments.enc
    )

  let gen_configurationDoneRequest =
    ( configurationDoneRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.configurationDone
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 ConfigurationDoneArguments.gen),
      RequestMessage.enc_opt
        Dap_commands.configurationDone
        ConfigurationDoneArguments.enc )

  let gen_launchRequest =
    ( launchRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.launch ~arguments ())
        @@ tup2 Gen.gen_int31 LaunchRequestArguments.gen),
      RequestMessage.enc Dap_commands.launch LaunchRequestArguments.enc )

  let gen_attachRequest =
    ( attachRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.attach ~arguments ())
        @@ tup2 Gen.gen_int31 AttachRequestArguments.gen),
      RequestMessage.enc Dap_commands.attach AttachRequestArguments.enc )

  let gen_restartRequest =
    ( restartRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.restart
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 RestartArguments.gen),
      RequestMessage.enc_opt Dap_commands.restart RestartArguments.enc )

  let gen_disconnectRequest =
    ( disconnectRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.disconnect
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 DisconnectArguments.gen),
      RequestMessage.enc_opt Dap_commands.disconnect DisconnectArguments.enc )

  let gen_terminateRequest =
    ( terminateRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.terminate
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 TerminateArguments.gen),
      RequestMessage.enc_opt Dap_commands.terminate TerminateArguments.enc )

  let gen_breakpointLocationsRequest =
    ( breakpointLocationsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.breakpointLocations
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 BreakpointLocationsArguments.gen),
      RequestMessage.enc_opt
        Dap_commands.breakpointLocations
        BreakpointLocationsArguments.enc )

  let gen_setBreakpointsRequest =
    ( setBreakpointsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setBreakpoints
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetBreakpointsArguments.gen),
      RequestMessage.enc Dap_commands.setBreakpoints SetBreakpointsArguments.enc
    )

  let gen_setFunctionBreakpointsRequest =
    ( setFunctionBreakpointsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setFunctionBreakpoints
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetFunctionBreakpointsArguments.gen),
      RequestMessage.enc
        Dap_commands.setFunctionBreakpoints
        SetFunctionBreakpointsArguments.enc )
    ...
    ( setExceptionBreakpointsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setExceptionBreakpoints
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetExceptionBreakpointsArguments.gen),
      RequestMessage.enc
        Dap_commands.setExceptionBreakpoints
        SetExceptionBreakpointsArguments.enc )

  let gen_dataBreakpointInfoRequest =
    ( dataBreakpointInfoRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.dataBreakpointInfo
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 DataBreakpointInfoArguments.gen),
      RequestMessage.enc
        Dap_commands.dataBreakpointInfo
        DataBreakpointInfoArguments.enc )

  let gen_setDataBreakpointsRequest =
    ( setDataBreakpointsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setDataBreakpoints
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetDataBreakpointsArguments.gen),
      RequestMessage.enc
        Dap_commands.setDataBreakpoints
        SetDataBreakpointsArguments.enc )

  let gen_setInstructionBreakpointsRequest =
    ( setInstructionBreakpointsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setInstructionBreakpoints
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetInstructionBreakpointsArguments.gen),
      RequestMessage.enc
        Dap_commands.setInstructionBreakpoints
        SetInstructionBreakpointsArguments.enc )

  let gen_continueRequest =
    ( continueRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.continue
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 ContinueArguments.gen),
      RequestMessage.enc Dap_commands.continue ContinueArguments.enc )

  let gen_nextRequest =
    ( nextRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.next ~arguments ())
        @@ tup2 Gen.gen_int31 NextArguments.gen),
      RequestMessage.enc Dap_commands.next NextArguments.enc )

  let gen_stepInRequest =
    ( stepInRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.stepIn ~arguments ())
        @@ tup2 Gen.gen_int31 StepInArguments.gen),
      RequestMessage.enc Dap_commands.stepIn StepInArguments.enc )

  let gen_stepOutRequest =
    ( stepOutRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.stepOut ~arguments ())
        @@ tup2 Gen.gen_int31 StepOutArguments.gen),
      RequestMessage.enc Dap_commands.stepOut StepOutArguments.enc )

  let gen_stepBackRequest =
    ( stepBackRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.stepBack
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 StepBackArguments.gen),
      RequestMessage.enc Dap_commands.stepBack StepBackArguments.enc )

  let gen_reverseContinueRequest =
    ( reverseContinueRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.reverseContinue
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 ReverseContinueArguments.gen),
      RequestMessage.enc
        Dap_commands.reverseContinue
        ReverseContinueArguments.enc )

  let gen_restartFrameRequest =
    ( restartFrameRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.restartFrame
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 RestartFrameArguments.gen),
      RequestMessage.enc Dap_commands.restartFrame RestartFrameArguments.enc )

  let gen_gotoRequest =
    ( gotoRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.goto ~arguments ())
        @@ tup2 Gen.gen_int31 GotoArguments.gen),
      RequestMessage.enc Dap_commands.goto GotoArguments.enc )

  let gen_pauseRequest =
    ( pauseRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.pause ~arguments ())
        @@ tup2 Gen.gen_int31 PauseArguments.gen),
      RequestMessage.enc Dap_commands.pause PauseArguments.enc )

  let gen_stackTraceRequest =
    ( stackTraceRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.stackTrace
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 StackTraceArguments.gen),
      RequestMessage.enc Dap_commands.stackTrace StackTraceArguments.enc )

  let gen_scopesRequest =
    ( scopesRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.scopes ~arguments ())
        @@ tup2 Gen.gen_int31 ScopesArguments.gen),
      RequestMessage.enc Dap_commands.scopes ScopesArguments.enc )

  let gen_variablesRequest =
    ( variablesRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.variables
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 VariablesArguments.gen),
      RequestMessage.enc Dap_commands.variables VariablesArguments.enc )

  let gen_setVariableRequest =
    ( setVariableRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setVariable
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetVariableArguments.gen),
      RequestMessage.enc Dap_commands.setVariable SetVariableArguments.enc )

  let gen_sourceRequest =
    ( sourceRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.source ~arguments ())
        @@ tup2 Gen.gen_int31 SourceArguments.gen),
      RequestMessage.enc Dap_commands.source SourceArguments.enc )

  let gen_threadsRequest =
    ( threadsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.threads
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 EmptyObject.gen),
      RequestMessage.enc_opt Dap_commands.threads EmptyObject.enc )

  let gen_terminateThreadsRequest =
    ( terminateThreadsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.terminateThreads
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 TerminateThreadsArguments.gen),
      RequestMessage.enc
        Dap_commands.terminateThreads
        TerminateThreadsArguments.enc )

  let gen_modulesRequest =
    ( modulesRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make ~seq ~command:Dap_commands.modules ~arguments ())
        @@ tup2 Gen.gen_int31 ModulesArguments.gen),
      RequestMessage.enc Dap_commands.modules ModulesArguments.enc )

  let gen_loadedSourcesRequest =
    ( loadedSourcesRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make_opt
              ~seq
              ~command:Dap_commands.loadedSources
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 LoadedSourcesArguments.gen),
      RequestMessage.enc_opt
        Dap_commands.loadedSources
        LoadedSourcesArguments.enc )

  let gen_evaluateRequest =
    ( evaluateRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.evaluate
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 EvaluateArguments.gen),
      RequestMessage.enc Dap_commands.evaluate EvaluateArguments.enc )

  let gen_setExpressionRequest =
    ( setExpressionRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.setExpression
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 SetExpressionArguments.gen),
      RequestMessage.enc Dap_commands.setExpression SetExpressionArguments.enc
    )

  let gen_stepInTargetsRequest =
    ( stepInTargetsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.stepInTargets
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 StepInTargetsArguments.gen),
      RequestMessage.enc Dap_commands.stepInTargets StepInTargetsArguments.enc
    )

  let gen_gotoTargetsRequest =
    ( gotoTargetsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.gotoTargets
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 GotoTargetsArguments.gen),
      RequestMessage.enc Dap_commands.gotoTargets GotoTargetsArguments.enc )

  let gen_completionsRequest =
    ( completionsRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.completions
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 CompletionsArguments.gen),
      RequestMessage.enc Dap_commands.completions CompletionsArguments.enc )

  let gen_exceptionInfoRequest =
    ( exceptionInfoRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.exceptionInfo
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 ExceptionInfoArguments.gen),
      RequestMessage.enc Dap_commands.exceptionInfo ExceptionInfoArguments.enc
    )

  let gen_readMemoryRequest =
    ( readMemoryRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.readMemory
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 ReadMemoryArguments.gen),
      RequestMessage.enc Dap_commands.readMemory ReadMemoryArguments.enc )

  let gen_writeMemoryRequest =
    ( writeMemoryRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.writeMemory
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 WriteMemoryArguments.gen),
      RequestMessage.enc Dap_commands.writeMemory WriteMemoryArguments.enc )

  let gen_disassembleRequest =
    ( disassembleRequest,
      QCheck.Gen.(
        map (fun (seq, arguments) ->
            RequestMessage.make
              ~seq
              ~command:Dap_commands.disassemble
              ~arguments
              ())
        @@ tup2 Gen.gen_int31 DisassembleArguments.gen),
      RequestMessage.enc Dap_commands.disassemble DisassembleArguments.enc )
end
...
module Response = struct
  ...
  let setExceptionBreakpointsResponse resp =
  ...
  let setInstructionBreakpointsResponse resp =
  ...
  (* response qcheck *)
  let gen_errorResponse =
    ( errorResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
              ~seq
              ~request_seq
              ~success
              ~command:Dap_commands.error
              ?message
              ~body
              ())
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ErrorResponse_body.gen),
      ResponseMessage.enc Dap_commands.error ErrorResponse_body.enc )

  let gen_cancelResponse =
    ( cancelResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.cancel EmptyObject.enc )

  let gen_runInTerminalResponse =
    ( runInTerminalResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             RunInTerminalResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.runInTerminal
    ...
    ( initializeResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             Capabilities.gen),
      ResponseMessage.enc_opt Dap_commands.initialize Capabilities.enc )

  let gen_configurationDoneResponse =
    ( configurationDoneResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.configurationDone EmptyObject.enc )
    ...
    ( launchResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.launch EmptyObject.enc )
    ...
    ( attachResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.attach EmptyObject.enc )

  let gen_restartResponse =
    ( restartResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.restart EmptyObject.enc )

  let gen_disconnectResponse =
    ( disconnectResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.disconnect EmptyObject.enc )

  let gen_terminateResponse =
    ( terminateResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.terminate EmptyObject.enc )

  let gen_breakpointLocationsResponse =
    ( breakpointLocationsResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             BreakpointLocationsResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.breakpointLocations
        BreakpointLocationsResponse_body.enc )

  let gen_setBreakpointsResponse =
    ( setBreakpointsResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetBreakpointsResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.setBreakpoints
        SetBreakpointsResponse_body.enc )
    ...
    ( setFunctionBreakpointsResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetFunctionBreakpointsResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.setFunctionBreakpoints
        SetFunctionBreakpointsResponse_body.enc )
    ...
    ( setExceptionBreakpointsResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetExceptionBreakpointsResponse_body.gen),
      ResponseMessage.enc_opt
        Dap_commands.setExceptionBreakpoints
        SetExceptionBreakpointsResponse_body.enc )

  let gen_dataBreakpointInfoResponse =
    ( dataBreakpointInfoResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             DataBreakpointInfoResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.dataBreakpointInfo
        DataBreakpointInfoResponse_body.enc )

  let gen_setDataBreakpointsResponse =
    ( setDataBreakpointsResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetDataBreakpointsResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.setDataBreakpoints
        SetDataBreakpointsResponse_body.enc )

  let gen_setInstructionBreakpointsResponse =
    ( setInstructionBreakpointsResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetInstructionBreakpointsResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.setInstructionBreakpoints
        SetInstructionBreakpointsResponse_body.enc )

  let gen_continueResponse =
    ( continueResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ContinueResponse_body.gen),
      ResponseMessage.enc Dap_commands.continue ContinueResponse_body.enc )

  let gen_nextResponse =
    ( nextResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.next EmptyObject.enc )

  let gen_stepInResponse =
    ( stepInResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.stepIn EmptyObject.enc )

  let gen_stepOutResponse =
    ( stepOutResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.stepOut EmptyObject.enc )

  let gen_stepBackResponse =
    ( stepBackResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.stepBack EmptyObject.enc )

  let gen_reverseContinueResponse =
    ( reverseContinueResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.reverseContinue EmptyObject.enc )

  let gen_restartFrameResponse =
    ( restartFrameResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.restartFrame EmptyObject.enc )

  let gen_gotoResponse =
    ( gotoResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.goto EmptyObject.enc )

  let gen_pauseResponse =
    ( pauseResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.pause EmptyObject.enc )
    ...
    ( stackTraceResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             StackTraceResponse_body.gen),
      ResponseMessage.enc Dap_commands.stackTrace StackTraceResponse_body.enc )
    ...
    ( scopesResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ScopesResponse_body.gen),
      ResponseMessage.enc Dap_commands.scopes ScopesResponse_body.enc )

  let gen_variablesResponse =
    ( variablesResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             VariablesResponse_body.gen),
      ResponseMessage.enc Dap_commands.variables VariablesResponse_body.enc )

  let gen_setVariableResponse =
    ( setVariableResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetVariableResponse_body.gen),
      ResponseMessage.enc Dap_commands.setVariable SetVariableResponse_body.enc
    )

  let gen_sourceResponse =
    ( sourceResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SourceResponse_body.gen),
      ResponseMessage.enc Dap_commands.source SourceResponse_body.enc )

  let gen_threadsResponse =
    ( threadsResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ThreadsResponse_body.gen),
      ResponseMessage.enc Dap_commands.threads ThreadsResponse_body.enc )
    ...
    ( terminateThreadsResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             Gen.gen_utf8_str_opt
             EmptyObject.gen),
      ResponseMessage.enc_opt Dap_commands.terminateThreads EmptyObject.enc )
    ...
    ( modulesResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ModulesResponse_body.gen),
      ResponseMessage.enc Dap_commands.modules ModulesResponse_body.enc )
    ...
    ( loadedSourcesResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             LoadedSourcesResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.loadedSources
        LoadedSourcesResponse_body.enc )
    ...
    ( evaluateResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             EvaluateResponse_body.gen),
      ResponseMessage.enc Dap_commands.evaluate EvaluateResponse_body.enc )

  let gen_setExpressionResponse =
    ( setExpressionResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             SetExpressionResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.setExpression
        SetExpressionResponse_body.enc )
    ...
    ( stepInTargetsResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             StepInTargetsResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.stepInTargets
        StepInTargetsResponse_body.enc )
    ...
    ( gotoTargetsResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             GotoTargetsResponse_body.gen),
      ResponseMessage.enc Dap_commands.gotoTargets GotoTargetsResponse_body.enc
    )
    ...
    ( completionsResponse,
      QCheck.Gen.(
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             CompletionsResponse_body.gen),
      ResponseMessage.enc Dap_commands.completions CompletionsResponse_body.enc
    )

  let gen_exceptionInfoResponse =
    ( exceptionInfoResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ExceptionInfoResponse_body.gen),
      ResponseMessage.enc
        Dap_commands.exceptionInfo
        ExceptionInfoResponse_body.enc )

  let gen_readMemoryResponse =
    ( readMemoryResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             ReadMemoryResponse_body.gen),
      ResponseMessage.enc_opt
        Dap_commands.readMemory
        ReadMemoryResponse_body.enc )

  let gen_writeMemoryResponse =
    ( writeMemoryResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
        ...
        @@ tup5
             ...
             bool
             Gen.gen_utf8_str_opt
             WriteMemoryResponse_body.gen),
      ResponseMessage.enc_opt
        Dap_commands.writeMemory
        WriteMemoryResponse_body.enc )

  let gen_disassembleResponse =
    ( disassembleResponse,
      QCheck.Gen.(
        map (fun (seq, request_seq, success, message, body) ->
            ResponseMessage.make_opt
...
module Event = struct
  ...
  type _ t =
    ...
    | TerminatedEvent :
        ...
        -> ( Dap_events.terminated,
           ...
           t
    | ThreadEvent :
        (Dap_events.thread, ThreadEvent_body.t, Presence.req) EventMessage.t
        -> (Dap_events.thread, ThreadEvent_body.t, Presence.req) EventMessage.t
           t
    | OutputEvent :
        (Dap_events.output, OutputEvent_body.t, Presence.req) EventMessage.t
        -> (Dap_events.output, OutputEvent_body.t, Presence.req) EventMessage.t
           t
    | BreakpointEvent :
        ...
        -> ( Dap_events.breakpoint,
           ...
           t
    | ModuleEvent :
        (Dap_events.module_, ModuleEvent_body.t, Presence.req) EventMessage.t
        -> (Dap_events.module_, ModuleEvent_body.t, Presence.req) EventMessage.t
           t
    | LoadedSourceEvent :
  ...
  (* event qcheck *)
  let gen_initializedEvent =
    ( initializedEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make_opt ~seq ~event:Dap_events.initialized ~body ())
        @@ tup2 Gen.gen_int31 EmptyObject.gen),
      EventMessage.enc_opt Dap_events.initialized EmptyObject.enc )

  let gen_stoppedEvent =
    ( stoppedEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.stopped ~body ())
        @@ tup2 Gen.gen_int31 StoppedEvent_body.gen),
      EventMessage.enc Dap_events.stopped StoppedEvent_body.enc )

  let gen_continuedEvent =
    ( continuedEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.continued ~body ())
        @@ tup2 Gen.gen_int31 ContinuedEvent_body.gen),
      EventMessage.enc Dap_events.continued ContinuedEvent_body.enc )

  let gen_exitedEvent =
    ( exitedEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.exited ~body ())
        @@ tup2 Gen.gen_int31 ExitedEvent_body.gen),
      EventMessage.enc Dap_events.exited ExitedEvent_body.enc )

  let gen_terminatedEvent =
    ( terminatedEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make_opt ~seq ~event:Dap_events.terminated ~body ())
        @@ tup2 Gen.gen_int31 TerminatedEvent_body.gen),
      EventMessage.enc_opt Dap_events.terminated TerminatedEvent_body.enc )

  let gen_threadEvent =
    ( threadEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.thread ~body ())
        @@ tup2 Gen.gen_int31 ThreadEvent_body.gen),
      EventMessage.enc Dap_events.thread ThreadEvent_body.enc )

  let gen_outputEvent =
    ( outputEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.output ~body ())
        @@ tup2 Gen.gen_int31 OutputEvent_body.gen),
      EventMessage.enc Dap_events.output OutputEvent_body.enc )

  let gen_breakpointEvent =
    ( breakpointEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.breakpoint ~body ())
        @@ tup2 Gen.gen_int31 BreakpointEvent_body.gen),
      EventMessage.enc Dap_events.breakpoint BreakpointEvent_body.enc )

  let gen_moduleEvent =
    ( moduleEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.module_ ~body ())
        @@ tup2 Gen.gen_int31 ModuleEvent_body.gen),
      EventMessage.enc Dap_events.module_ ModuleEvent_body.enc )

  let gen_loadedSourceEvent =
    ( loadedSourceEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.loadedSource ~body ())
        @@ tup2 Gen.gen_int31 LoadedSourceEvent_body.gen),
      EventMessage.enc Dap_events.loadedSource LoadedSourceEvent_body.enc )

  let gen_processEvent =
    ( processEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.process ~body ())
        @@ tup2 Gen.gen_int31 ProcessEvent_body.gen),
      EventMessage.enc Dap_events.process ProcessEvent_body.enc )

  let gen_capabilitiesEvent =
    ( capabilitiesEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.capabilities ~body ())
        @@ tup2 Gen.gen_int31 CapabilitiesEvent_body.gen),
      EventMessage.enc Dap_events.capabilities CapabilitiesEvent_body.enc )

  let gen_progressStartEvent =
    ( progressStartEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.progressStart ~body ())
        @@ tup2 Gen.gen_int31 ProgressStartEvent_body.gen),
      EventMessage.enc Dap_events.progressStart ProgressStartEvent_body.enc )

  let gen_progressUpdateEvent =
    ( progressUpdateEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.progressUpdate ~body ())
        @@ tup2 Gen.gen_int31 ProgressUpdateEvent_body.gen),
      EventMessage.enc Dap_events.progressUpdate ProgressUpdateEvent_body.enc )

  let gen_progressEndEvent =
    ( progressEndEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.progressEnd ~body ())
        @@ tup2 Gen.gen_int31 ProgressEndEvent_body.gen),
      EventMessage.enc Dap_events.progressEnd ProgressEndEvent_body.enc )

  let gen_invalidatedEvent =
    ( invalidatedEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.invalidated ~body ())
        @@ tup2 Gen.gen_int31 InvalidatedEvent_body.gen),
      EventMessage.enc Dap_events.invalidated InvalidatedEvent_body.enc )

  let gen_memoryEvent =
    ( memoryEvent,
      QCheck.Gen.(
        map (fun (seq, body) ->
            EventMessage.make ~seq ~event:Dap_events.memory ~body ())
        @@ tup2 Gen.gen_int31 MemoryEvent_body.gen),
      EventMessage.enc Dap_events.memory MemoryEvent_body.enc )
end
