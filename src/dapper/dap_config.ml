...
let make
    ...
    ?(backend_echo=_backend_echo) () =
  {backend_ip; backend_port; backend_cmd; stepper_cmd; backend_echo; script_filename}
...
let stepper_cmd t = t.stepper_cmd t.script_filename
