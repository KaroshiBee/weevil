...
type error = (Dap_commands.error, M.ErrorResponse_body.t, M.Presence.req) Res.Message.t Res.t
...
let get_error_str t =
  ...
  let enc = Res.Message.enc Dap_commands.error M.ErrorResponse_body.enc in
