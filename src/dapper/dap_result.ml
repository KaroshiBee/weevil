...
module Presence = Dap.Presence
open Dap.Response

type error = (Dap_commands.error, Dap.ErrorResponse_body.t, Presence.req) ResponseMessage.t t
...
let get_error_str t =
  ...
  let enc = ResponseMessage.enc Dap_commands.error Dap.ErrorResponse_body.enc in
